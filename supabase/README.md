...
Reste à écrire : traitement des courses `a_verifier`. Réception des réponses SMS entrantes du destinataire (RG-46) : bloquée par le même point ouvert que ci-dessous (agrégateur SMS).
